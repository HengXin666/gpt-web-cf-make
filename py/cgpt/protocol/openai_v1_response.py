...
from ..helper import extract_image_from_message_content, extract_response_prompt, has_response_image_generation_tool
...
def response_events(body: dict[str, Any]) -> Iterator[dict[str, Any]]:
    ...
    images = encode_images([(image_info[0], "image.png", image_info[1])]) if image_info else None
